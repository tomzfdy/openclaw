...
const EXAMPLES = [
  ["openclaw setup", "Initialize local config and the default workspace."],
  ["openclaw dashboard", "Open the local Control UI in your browser."],
  ["openclaw sessions --json", "Inspect stored conversation sessions as JSON."],
  ["openclaw tasks list", "List tracked background tasks."],
  ["openclaw completion --shell zsh", "Generate shell completion output."],
] as const;
